...
const Home = ({ mode }) => {
  ...
  const [text] = useTypewriter({
    words: ['Taranjeet Singh', 'Web Developer'],
    loop: {},
    typeSpeed: 120,
    deleteSpeed: 80
  });
        ...
        <div className='mb-10'>
          ...
          <div className='sm:flex items-center '>
            <a target="_blank" href='https://drive.google.com/file/d/1C5oSRD2s-oPzFrDmSYEwRvAl4Mlfl3Yg/view?usp=sharing' >
              <span className={`mr-2 shadow-2xl ${mode ? "shadow-black" : "shadow-white"} hover:shadow-[#448AFF] group border-2 border-[${mode ? "black" : "white"}] px-6 py-3 my-2 flex items-center  rounded-full justify-center  hover:text-white hover:bg-[#448AFF] hover:border-[#448AFF] duration-300`}>
            ...
            <div className='flex justify-center mt-10 sm:m-1'>
              <a href="https://www.linkedin.com/in/tjsingh47/" target='_blank' className=' p-2' >
                <span className={`shadow-2xl ${mode ? "shadow-black" : "shadow-white"} hover:shadow-[#448AFF] border-2 border-[${mode ? "black" : "white"}] px-2 py-2 flex rounded-full  ${mode ? "bg-black" : "bg-white"} hover:bg-[#448AFF] justify-center hover:border-[#448AFF] duration-300`}>
